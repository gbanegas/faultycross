...
For the VOLEitH/MPCitH family, Jendral and Dubrova~\cite{JendralD25} demonstrated side-channel and fault attacks 
on masked FAEST, targeting the PRG used in GGM child-node generation. In~\cite{BandaBK26}, the authors studied fault 
attacks on MPCitH schemes (Mirath, RYDE), targeting both the Expand and challenge phases.
