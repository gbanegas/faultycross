...
$\calH = \{i : c_i \neq 0\}$ and $\calR = \{i : c_i = 0\}$.  Flag propagation
follows the same bottom-up rule as MEDS.  The distinct feature of CROSS is that
a non-zero challenge value $c_i \in \{1, 2\}$ identifies \emph{which} of
$s-1$ secret components the corresponding response encodes; a fault exposing
$\eseed_i$ thus recovers the $c_i$-th component of the long-term secret.
