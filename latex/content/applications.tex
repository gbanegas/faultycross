...
\paragraph{Objective.}
The main goal as an attacks is to manipulate the control flow 
...
\textit{Subtree recovery.} This attack is successful if 
...
\paragraph{Single hidden leaf recovery.}
