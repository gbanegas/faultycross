...
\begin{figure}[htp]
    \centering
    \includegraphics[width=0.73\textwidth]{content/images/glitch_2d_results_ext2.png}
...
\textit{Model 3: Single hidden leaf recovery.}
...
\textbf{Parameters.} The disassembled code shows that the assignement is done in two instructions, first The CPU loads the integer value 1 into 
