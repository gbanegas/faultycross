...
The published path $\tpath$ consists of the highest surviving nodes in
the tree, serialised in depth-first order. Equivalently,
\[
\tpath
 = \{\, v : v \text{ retains its label and }
...
argument as in Appendix~\ref{app:proof-less}.
