...
\begin{itemize}
    ...
    From $(\mathsf{rseed},\, \mathsf{salt})$, RYDE and Mirthe build a binary tree of $N = \sum_{e=1}^{\tau} N_e$ internal nodes by top-down \textsf{ExpandSeed} expansion, storing the result in a heap-indexed array $mathsf{tree}[0 \ldots 2N-1]$.
