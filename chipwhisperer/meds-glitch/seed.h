...
void stree_to_path_to_stree_glitch(uint8_t *stree, uint8_t *h_digest, uint8_t *path, uint8_t *salt, int mode);

#define stree_to_path_glitch(stree, h, path, salt) stree_to_path_to_stree_glitch(stree, h, path, salt, STREE_TO_PATH)
#define path_to_stree_glitch(stree, h, path, salt) stree_to_path_to_stree_glitch(stree, h, path, salt, PATH_TO_STREE)
